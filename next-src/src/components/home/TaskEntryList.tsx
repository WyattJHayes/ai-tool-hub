    ...
    <div className="grid grid-cols-1 border-y border-[var(--line)] sm:grid-cols-2 lg:grid-cols-4">
      {scenes.map((scene) => (
          <Link
            ...
            className="group flex min-h-[104px] items-center justify-between gap-3 border-l-[3px] border-l-transparent border-b border-[var(--line)] px-5 py-4 hover:border-l-[var(--accent)] hover:bg-[var(--surface-hover)] sm:border-r lg:min-h-[90px]"
          >
